    ...
    div [ class "start-wrapper" ]
        ...
        , div [ class "how-to-play" ]
            ...
            , div [ classList [ ( "show", slideToShow == 1 ) ] ]
                [ img [ src "assets/stickman-headphones.jpeg" ] []
            ...
            , div [ classList [ ( "show", slideToShow == 2 ) ] ]
                [ img [ src "assets/stickman-writing.png" ] []
            ...
            , div [ classList [ ( "show", slideToShow == 3 ) ] ]
                [ img [ src "assets/stickman-teams.png" ] []
                , h3 [] [ text "3. Start Playing" ]
                , p [] [ text "Once you start the game you will be devided into compeating teams of 2" ]
                ]
            , div [ classList [ ( "show", slideToShow == 4 ) ] ]
                [ img [ src "assets/stickman-explaining.jpeg" ] []
            ...
            , div [ classList [ ( "show", slideToShow == 5 ) ] ]
                [ img [ src "assets/stickman-learning.jpeg" ] []
            ...
            , div [ classList [ ( "show", slideToShow == 0 ) ] ]
                [ img [ src "assets/stickman-zipped.jpeg" ] []
                , h3 [] [ text "6. Can you describe it with only one word?" ]
